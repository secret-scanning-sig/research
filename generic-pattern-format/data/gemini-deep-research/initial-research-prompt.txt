Here's the draft of a research project I'm working on:
...
This isn't for school, it's research for a Special Interest Group for secrets scanners.

I want you to:

- Look for existing tools that do this well
- Pick a set of initial translation targets (at least the ones that were listed in the doc, but more if useful)
- Detail common and different features to take into consideration in the format.
